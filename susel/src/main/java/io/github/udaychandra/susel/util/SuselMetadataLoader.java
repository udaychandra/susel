...
import static io.github.udaychandra.susel.common.Constants.SUSEL_METADATA_RESOURCE_PATH;
...
public class SuselMetadataLoader {
    ...
    /**
     * Load and get Susel {@link MetadataItem} of the module holding the specified service provider.
     *
     * @param serviceProvider the class that provides a specific service.
     * @param <S> the type of service provided.
     * @return the Susel {@link MetadataItem} of the module holding the specified service provider.
